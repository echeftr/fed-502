...
Neem onderstaande functie over in je VS code
...
1  Hoe ziet elk object eruit? Log all objecten in de loop. Voorzie je console.log van een begeleidende tekst, zodat je weet wat je gaat loggen (good practice):
 ...
 const array = [
  ...
  for (let person of array) {
    ...
    // console.log("Dit is persoonnaam ", [person.name]); // opdracht 2
    // console.log("Year of birth is ", 2020 - [person.age]) // opdracht 3 
    // console.log(person.name, 'is een', person.profession, 'als beroep.' ); // opdracht 4
